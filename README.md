...
`size_t cmsdf_draw_edges(const cmsdf_edge_array* edges, const cmsdf_raster_params* params, uint32_t* pixels)` works the same, except that it outputs an images showing the internal edge color channel assignment.
